...
generate-protoc:
	...
	\
	--go_out=. --go_opt=paths=import --go_opt=module=github.com/ushakovn-org/loghouse \
	--go-grpc_out=. --go-grpc_opt=paths=import --go-grpc_opt=module=github.com/ushakovn-org/loghouse \
	--grpc-gateway_out=. --grpc-gateway_opt=paths=import --grpc-gateway_opt=module=github.com/ushakovn-org/loghouse \
	...
	--validate_out="lang=go,module=github.com/ushakovn-org/loghouse,paths=import:." \
	\
	./api/**/*.proto
